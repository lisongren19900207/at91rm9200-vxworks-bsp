...
//			Edit
//				AT91C_AIC_SRCTYPE_INT_LEVEL_SENSITIVE : High-Level Sensitive
//				AT91C_AIC_SRCTYPE_INT_EDGE_SENSITIVE : Positive Edge Triggered
// ----------------------------------------------------------------------------
...
#define 	AT91C_AIC_SRCTYPE_INT_LEVEL_SENSITIVE  ((unsigned int) 0x0 <<  5) // (AIC) Internal Sources Code Label High-Level Sensitive
#define 	AT91C_AIC_SRCTYPE_INT_EDGE_TRIGGERED   ((unsigned int) 0x1 <<  5) // (AIC) Internal Sources Code Label Positive Edge triggered
